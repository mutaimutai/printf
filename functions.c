...
/**
*print binary-prints Unsigned number
*@t-list of arguments
*@b-buffers array to hande the print
*@f-used to calculate the flags that are active
*@w-get the width
*@p-the specification of precision
*@s-specifiers size
*@Return - this returns number of characters that will be printed
*/
int print_binary(va_list types,char b[],int f,int w,int p,int s)
{
